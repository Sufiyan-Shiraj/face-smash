...
export function Modals({ activeModal, onClose, soundMuted, onToggleSound }) {
            ...
            <div className="space-y-4">
              <div className="p-3 bg-gray-800/60 rounded-2xl border border-gray-700/60 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-sans text-xs text-gray-400">Upload a face photo or snap your camera.</p>
                </div>
              </div>
              ...
              <div className="p-3 bg-gray-800/60 rounded-2xl border border-gray-700/60 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-sans text-xs text-gray-400">Facial landmarks are extracted into a squishy digital ragdoll head.</p>
                </div>
              </div>
              ...
              <div className="p-3 bg-gray-800/60 rounded-2xl border border-gray-700/60 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-sans text-xs text-gray-400">Pick from weapons (Punch, Slap, Brick, Spoon, Banana, etc.) and relieve your stress.</p>
                </div>
              </div>
            </div>
          </div>
