...
const HEAD_GLB = '/base_basic_shaded.glb'
...
export function ScannedHead({ onBeforeCompile, url = HEAD_GLB }) {
  ...
  const isCustomModel = url && url !== HEAD_GLB && url !== DUMMY_GLB && url !== '/models/head_opt.glb'
  ...
  return (
    <group>
      ...
      <primitive
        object={head}
        scale={0.285}
        position={isCustomModel ? [0, -0.290, -0.045] : [0.012, -0.325, -0.035]}
        rotation={[0, 0, 0]}
      />
